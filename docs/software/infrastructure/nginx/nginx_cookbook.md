...
[HTTP Health Check](https://docs.nginx.com/nginx/admin-guide/load-balancer/http-health-check)
[TCP Health Check](https://docs.nginx.com/nginx/admin-guide/load-balancer/tcp-health-check)
[UDP Health Check](https://docs.nginx.com/nginx/admin-guide/load-balancer/udp-health-check)
...
[nginx HTTP GeoIP Module](http://nginx.org/en/docs/http/ngx_http_geoip_module.html)
